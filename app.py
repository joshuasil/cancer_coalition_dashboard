...
conn = engine.connect()
sql_select_query = text('''SELECT * FROM public.cancer_co_logs;''')
...
sph_logo = Image.open('logo.png')
sph_logo = sph_logo.convert('RGB')
...
navbar = dbc.NavbarSimple(
    ...
    brand="Clinic Chat - Colorado Cancer Coalition Chatbot Dashboard",
    brand_href="#",
    color="primary",
    dark=True,
)
...
if __name__ == '__main__':
    app.run_server(host="localhost", port=8090,debug=False)